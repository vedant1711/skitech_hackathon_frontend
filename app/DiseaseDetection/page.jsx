...
export default function DiseaseDetection() {
    ...
    const handleGetDetails = () => {
        setShowDetails(true);
        // Fetch and update details here based on cropName and diseaseName if needed
    };
                    ...
                    <div className="container px-4">
                        <div className="md:w-3/4 lg:w-1/2 mx-auto text-center">
                            ...
                            <button
                                ...
                                className="mt-8 btn bg-primary-light-950 dark:bg-primary-dark-950 hover:bg-primary-light-800 dark:hover:bg-primary-dark-800 rounded-full px-8 py-4 text-xl text-neutral-950 dark:text-neutral-dark-950">
                                Get Details
                            </button>
                        </div>
                    </div>
                            ...
                            <div className="container px-4">
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
                                    <div className="bg-neutral-50 p-8 rounded-lg shadow-md text-center">
                                        ...
                                        <h4 className="text-lg font-semibold mb-2">Dr. Emily Smith</h4>
                                        <p className="text-base font-md text-neutral-700 dark:text-neutral-dark-700">
                                            A renowned expert in agricultural sciences with over 15 years of experience in crop disease management.
                                        </p>
                                    </div>
                                    <div className="bg-neutral-50 p-8 rounded-lg shadow-md text-center">
                                        <img src="/assets/imgs/avatar/avatar-02.png" alt="Expert 2" className="rounded-full w-24 h-24 mx-auto mb-4" />
                                        <h4 className="text-lg font-semibold mb-2">Dr. John Lee</h4>
                                        <p className="text-base font-md text-neutral-700 dark:text-neutral-dark-700">
                                            A leading researcher in plant pathology with a focus on sustainable agriculture and disease prevention.
                                        </p>
                                    </div>
                                    <div className="bg-neutral-50 p-8 rounded-lg shadow-md text-center">
                                        <img src="/assets/imgs/avatar/avatar-01.png" alt="Expert 3" className="rounded-full w-24 h-24 mx-auto mb-4" />
                                        <h4 className="text-lg font-semibold mb-2">Dr. Maria Garcia</h4>
                                        <p className="text-base font-md text-neutral-700 dark:text-neutral-dark-700">
                                            A professor of horticulture specializing in the diagnosis and treatment of crop diseases.
                                        </p>
                                    </div>
                                </div>
                            </div>
