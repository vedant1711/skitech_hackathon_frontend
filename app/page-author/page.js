        ...
        <>
            <Layout>
                ...
                <section className="relative pt-20 py-10 lg:pt-12 lg:pb-24">
                    <div className="container px-4">
                        <div className="mb-16">
                            <h3 className="heading-2 text-left mb-4 lg:mb-4"><span className="font-light">Posted by</span> {data.author.name}</h3>
                        </div>
