...
import {fetchUser} from "../../util/helper"
...
const authorDummy =  {
      ...
      "description": "You should write because you love the shape of stories and sentences and the creation of different words on a page. Graduating from a top accelerator or incubator can be as career-defining for a startup founder as an elite university diploma."
    }
   ...
   const articles = [
      {
        "image": "/assets/imgs/pages/img-01.png",
        "link": "/single",
        "category": {
          "name": "Technology",
          "link": "/category"
        ...
        "title": "Transformative Learning: Adapting to Educational Innovations"
      },
      {
        "image": "/assets/imgs/pages/img-02.png",
        "link": "/single",
        "category": {
          "name": "Health",
          "link": "/category"
        ...
        "title": "The Future of Medicine: Personalized Healthcare"
      },
      {
        "image": "/assets/imgs/pages/img-03.png",
        "link": "/single",
        "category": {
          "name": "Finance",
          "link": "/category"
      ...
      {
        "image": "/assets/imgs/pages/img-04.png",
        "link": "/single",
        "category": {
          "name": "Lifestyle",
          "link": "/category"
        ...
        "title": "Mindfulness in Everyday Life: Practices and Benefits"
      },
      {
        "image": "/assets/imgs/pages/img-05.png",
        "link": "/single",
        "category": {
          "name": "Science",
          "link": "/category"
        ...
        <>
            <Layout>
                        ...
                        <div className="w-full rounded-[26px] bg-gradient-to-t from-primary-light-950 via-primary-light-300 to-primary-light-200 p-1.5">
                            <div className="flex flex-col md:flex-row rounded-[21px] h-full w-full items-center justify-center bg-neutral-0 dark:bg-neutral-dark-0 back p-2 md:p-2 lg:p-16">
                                <div className="md:pr-16 md:min-w-72 lg:min-w-96 rounded-3xl overflow-hidden">
                                    <img className="rounded-3xl md:min-w-96" src= {author?.photo} alt="" />
                                </div>
                                <div className="p-2 md:p-2 lg:py-12 md:pl-8 lg:pl-16">
                                    <h3 className="heading-3 mb-4">{author.first_name} {author.last_name}</h3>
                                    ...
                                    <div className="flex gap-2 mt-12">
                                        ...
                                        <button className="h-12 px-4 rounded-[5px] flex justify-center items-center bg-primary-light-950 dark:bg-primary-dark-950 cursor-pointer hover-up text-neutral-950 dark:text-neutral-dark-950 text-xl font-medium" onClick={() => router.push("/createBlogPost")}>
                                            Add Post
                                        </button>
                                    </div>
                                </div>
                ...
                <section className="relative pt-20 py-10 lg:pt-12 lg:pb-24">
                    <div className="container px-4">
                        <div className="mb-16">
                            <h3 className="heading-2 text-left mb-4 lg:mb-4"><span className="font-light">Posted by</span> {author.name}</h3>
                        </div>
            ...
            {articles.map((article, index) => (
                <div key={index} className="flex-col md:flex-row justify-start items-center gap-5 inline-flex hover-up border-2 bg-neutral-0 dark:bg-neutral-dark-0 border-neutral-300 dark:border-neutral-dark-300 rounded-3xl overflow-hidden w-full p-2">
                    <Link href={article.link} className="rounded-2xl overflow-hidden md:max-w-[280px]">
                        <img src={article.image} alt={article.title} />
                    </Link>
                    <div className="flex-col justify-start items-start gap-3.5 flex pl-4 pr-6 pb-4">
                        <div className="justify-start items-center gap-5 inline-flex">
                            <Link href={article.category.link} className="px-3 py-[8px] bg-neutral-200 dark:bg-neutral-dark-200 rounded-3xl border border-neutral-200 dark:border-neutral-dark-300 justify-center items-center gap-2.5 flex">
                                <div className="text-neutral-900 dark:text-neutral-dark-950 text-sm font-medium leading-none">
                                    {article.category.name}
                                </div>
                            </Link>
                        </div>
                        <div className="text-neutral-900 dark:text-neutral-dark-950 text-lg font-semibold leading-tight">
                            {article.title}
                        </div>
                        <div className="text-neutral-500 dark:text-neutral-dark-500 text-sm">
                            {article.metadata.date} • {article.metadata.readTime}
                        </div>
                    </div>
                </div>
            ))}
