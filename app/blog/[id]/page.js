                            ...
                            <div className="container px-4">
                                <div className="flex w-full justify-center item-center mb-16">
                                    ...
                                    <div className="hidden md:flex gap-2.5  justify-start items-center h-12 px-7 py-3.5 bg-neutral-0 dark:bg-neutral-dark-0 rounded-3xl border border-neutral-300 dark:border-neutral-dark-300">
                                        ...
                                        <span className="text-neutral-900 dark:text-neutral-dark-950 text-base font-bold leading-snug">{blogPost.title} </span>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-4 items-center justify-center text-center">
                                    <div className="justify-center items-center gap-4 flex flex-col md:flex-row">
                                        <Link href="/category" className="inline-flex  px-3 py-[8px] bg-neutral-200 dark:bg-neutral-dark-200 rounded-3xl border border-neutral-300 dark:border-neutral-dark-300 justify-center items-center gap-2.5">
                                            <span className="text-neutral-900 dark:text-neutral-dark-950 text-sm font-medium leading-none">{blogPost.category}</span>
                                        </Link>
                                        <div className="justify-start items-center gap-2 flex">
                                            <Link href="/author"><img className="w-9 h-9 rounded-3xl" src={`/assets/imgs/avatar/${blogPost.avatar}`} /></Link>
                                            <div className="text-neutral-700 text-sm font-medium leading-none dark:text-neutral-dark-700"><Link href="/author">{blogPost.author}</Link> - {blogPost.date}</div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex flex-col lg:flex-row justify-between gap-[58px]">
                                    <div className="post-content max-w-[850px]">
                                        ...
                                        <div className="single-content text-base font-medium text-neutral-950 dark:text-neutral-dark-950 leading-relaxed max-w-[850px]">
                                            <img src={`/assets/imgs/pages/${blogPost.img}`} className="rounded-3xl mb-8" alt="" />
                                        ...
                                        <div className="subscrible p-12 rounded-3xl bg-neutral-200 dark:bg-neutral-dark-200">
                                            ...
                                            <form className="max-w-full overflow-hidden">
                                                <div className="flex flex-col md:flex-row mb-4 md:bg-neutral-0 dark:bg-neutral-dark-200 border border-neutral-950 dark:border-neutral-700 rounded-xl overflow-hidden">
                                                    ...
                                                    <button className="group w-full mr-[-3px] sm:w-auto h-14 py-4 px-6 rounded-xl bg-neutral-950 dark:bg-neutral-700 transition duration-200 flex items-center justify-center gap-2" type="submit">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={18} height={16} viewBox="0 0 18 16" className="fill-primary-light-950 group-hover:fill-neutral-0">
