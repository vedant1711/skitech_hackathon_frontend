                        ...
                        <div className="mb-12 md:mb-0">
                            <form className="max-w-full overflow-hidden" action>
                                <div className="flex flex-col md:flex-row mb-4 md:bg-neutral-0 dark:bg-neutral-dark-200 rounded-full p-1 md:border border-neutral-300 dark:border-neutral-dark-300">
                                    <input className="focus:outline-none transition duration-200 py-4 bg-neutral-0 dark:bg-neutral-dark-200 rounded-full pl-6 w-full mb-2 md:mb-0 md:border-0 border border-neutral-300 dark:border-neutral-dark-300 " type="text" placeholder="Email address" />
                                    <button className="w-full sm:w-auto h-14 py-4 px-6 rounded-full bg-primary-light-950 dark:bg-primary-dark-950 transition duration-200 flex items-center justify-center gap-2" type="submit">
                                        <svg width={22} height={18} viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 fill-neutral-950" preserveAspectRatio="none">
                                        ...
                                        <span className="text-neutral-950 font-medium text-2xl">Subscribe</span>
                                    </button>
                                </div>
                                <div className="flex items-start justify-start mt-8 pl-4">
                                    ...
                                    <label htmlFor="checkbox" className="text-neutral-700 text-sm ml-2 cursor-pointer">I agree to the <a href="#" className="text-neutral-950 dark:text-neutral-dark-950 font-bold">Terms &amp;
                                        conditions</a></label>
                                </div>
                            </form>
                        </div>
                ...
                <div className="container px-4">
                    ...
                    <div className="grid lg:grid-cols-2">
                        ...
                        <div className="grid grid-cols- lg:grid-cols-3 md:grid-cols-3">
                            ...
                            <div className="mb-4">
                                <h6 className="text-base font-bold text-neutral-700 dark:text-neutral-dark-700 mb-2">Pages</h6>
                                <ul>
                                    <li className="footer-menu">
                                        <a href="/page-about" className="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">About
                                            me</a>
                                    </li>
                                    <li className="footer-menu">
                                        <a href="/page-contact" className="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Contact</a>
                                    </li>
                                    <li className="footer-menu">
                                        <a href="/page-author" className="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Author</a>
                                    </li>
                                    <li className="footer-menu">
                                        <a href="/page-search" className="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Search
                                            results</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="mb-4">
                                <h6 className="text-base font-bold text-neutral-700 dark:text-neutral-dark-700 mb-2">Account</h6>
                                <ul>
                                    <li className="footer-menu">
                                        <a href="/page-register" className="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Register</a>
                                    </li>
                                    <li className="footer-menu">
                                        <a href="/page-login" className="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Login</a>
                                    </li>
                                    <li className="footer-menu">
                                        <a href="/page-forgot-password" className="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">Forgot
                                            Password</a>
                                    </li>
                                    <li className="footer-menu">
                                        <a href="/page-404" className="text-base font-regular text-neutral-950 dark:text-neutral-dark-950">404</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
